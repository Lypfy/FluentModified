    ...
    [17] = function()
        ...
        return function(t)
            ...
            function v.Destroy(M)
                ...
                if windowState.Minimizer then
                    pcall(function()
                        if typeof(windowState.Minimizer) == "Instance" then
                            windowState.Minimizer:Destroy()
                        elseif type(windowState.Minimizer) == "table" and type(windowState.Minimizer.Destroy) == "function" then
                            windowState.Minimizer:Destroy()
                        end
                    end)
                    windowState.Minimizer = nil
                end
                if lib then
